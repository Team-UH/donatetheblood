...
<div class="container size">
		...
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
			...
			<?php   if (isset($blood_groupError)) 
              ...
              <input type="text" name="contact_no" placeholder="" class="form-control" required pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" value="<?php if (isset($contact)) 
						echo $contact;
					?>">
	...
	<option value="">-- Select --</option><?php if(isset($city)) echo '<option selected="" value="'.$city.'">'.$year.'</option>'; ?><optgroup title="Andhra Pradesh" label="&raquo; Andhra Pradesh"></optgroup>
